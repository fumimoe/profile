...
const productLists =[{
    img:portfolio1,
    title:'ポートフォリオサイト',
    message:'ポートフォリオサイトを作成しました！学んだ知識を生かしていろんなサービスを作っていきたいと思います！'
},
{
    img:comingsoon,
    title:'随時更新',
    ...
    return (
        <div>
            ...
            {productLists.map((productList,index) =>
                ...
                <div className={styles.container}><CardDetail key={index} img={productList.img} title={productList.title} message={productList.message}/></div>
            )}
            </Slider>
        </div>
    )
