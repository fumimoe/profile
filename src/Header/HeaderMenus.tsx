...
const HeaderMenus = () => {
    ...
    const list = (anchor: Anchor) => (
      ...
      >
        ...
        <List>
          {['ホーム', 'スキル', 'プロフィール', '問い合わせ'].map((text, index) => (
            <ListItem button key={text}>
                ...
                {index === 1 &&(
                    ...
                    <label>
                    <Link to="/skill" >
                    <ListItemIcon><IconButton><CreateNewFolderIcon/></IconButton></ListItemIcon>
                 ...
                 {index === 3 &&(
                     ...
                     <label>
                     <Link to="/contact">
                     <ListItemIcon><IconButton><SendIcon /></IconButton></ListItemIcon>
    ...
    return (
        <div>
          ...
          <React.Fragment >
            <IconButton onClick={toggleDrawer('left', true)}><MenuIcon></MenuIcon></IconButton>
            <Drawer anchor='left' open={stateOpen['left']} onClose={toggleDrawer('left', false)}>
              {list('left')}
            </Drawer>
          </React.Fragment>
